...
{\color{red} \faStar} NodeJS, AngularJS
CSS3 \& HTML5
Haml \& Jade
Sass \& Less
\LaTeX{}
...
{\emph{Développeur Backend}
\vspace{5pt}\\
\textbf{Développement d'une application de réservation de loisirs actifs, bénéfiques et conviviaux}. Je me concentre principalement sur la partie backend réalisée en \hi{JavaScript} à l'aide du \emph{framework} \hi{NodeJS}.}
%------------------------------------------------
\entry
{Sept'08 – Déc'14}
{PleinNet}

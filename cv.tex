...
\header{François}{VANTOMME}{développeur web} % Your name and current job title/field
...
Récemment nous avons réécrit l'outil de répartition automatique de containers à l'aide de \hi{NodeJS} et \hi{GLPK} (bibliothèque de programmation linéaire), le rendant ainsi indépendant du reste de l'application et bien plus performant.
\vspace{5pt}\\
...
\vspace{5pt}\\
\textbf{Mise en place de solutions OS Commerce} et développements spécifiques en \hi{PHP} liés au e-commerce.}
%------------------------------------------------
\end{entrylist}
